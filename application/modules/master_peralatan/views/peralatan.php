        ...
        <div id="kt_app_content_container" class="app-container  container-xxl ">
            <div class="card">
                ...
                <div class="card-body pt-0">
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_m_peralatan_table">
                        <thead>
...
<div class="modal fade" tabindex="-1" id="modal_add_peralatan">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Tambah jenis peralatan (Master)</h3>
            ...
            <div class="modal-body">
                <form method="POST" class="form w-100" id="form-tambah-m-jenis-peralatan">
					<div class="fv-row mb-5 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
						<label for="nama_jenis_peralatan" class="required form-label">Nama jenis peralatan</label>
						<input type="text" class="form-control form-control-solid" name="nama_jenis_peralatan" placeholder="Masukkan nama jenis peralatan"/>
            ...
            <div class="modal-footer">
                ...
                <div class="d-flex flex-stack">
					<button id="btn-submit-tambah-m-jenis-peralatan" class="btn btn-primary me-2 flex-shrink-0">
						<span class="indicator-label" data-kt-translate="btn-submit-tambah-m-jenis-peralatan">
							Simpan
						</span>
...
<div class="modal fade" tabindex="-1" id="modal_edit_peralatan">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Edit jenis peralatan (Master)</h3>
            ...
            <div class="modal-body">
                <form method="POST" class="form w-100" id="form-edit-m-jenis-peralatan">
					<input type="text" hidden name="edit_id_jenis_peralatan">
					<div class="fv-row mb-5 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
						<label for="nama_jenis_peralatan" class="required form-label">Nama jenis peralatan</label>
						<input type="text" class="form-control form-control-solid" name="edit_nama_jenis_peralatan" placeholder="Masukkan nama jenis peralatan"/>
						<div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
					</div>
				</form>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                <div class="d-flex flex-stack">
					<button id="btn-submit-edit-m-jenis-peralatan" class="btn btn-primary me-2 flex-shrink-0">
						<span class="indicator-label" data-kt-translate="btn-submit-edit-m-jenis-peralatan">
							Simpan
						</span>
						<span class="indicator-progress">
							<span data-kt-translate="general-progress">Harap tunggu...</span>
