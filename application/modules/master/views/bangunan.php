        ...
        <div id="kt_app_content_container" class="app-container  container-xxl ">
            <div class="card">
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-bangunan-table-toolbar="base">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_add_bangunan"> Tambah </button>
                        </div>
                ...
                <div class="card-body pt-0">
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_m_bangunan_table">
                        <thead>
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                <th class="min-w-125px">Jenis Bangunan</th>
...
<div class="modal fade" tabindex="-1" id="modal_add_bangunan">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Tambah jenis bangunan (Master)</h3>
            ...
            <div class="modal-body">
                <form method="POST" class="form w-100" id="form-tambah-m-bangunan">
					<div class="fv-row mb-5 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
						<label for="nama_bangunan" class="required form-label">Jenis bangunan</label>
						<input type="text" class="form-control form-control-solid" name="nama_bangunan" placeholder="Masukkan jenis bangunan"/>
            ...
            <div class="modal-footer">
                ...
                <div class="d-flex flex-stack">
					<button id="btn-submit-tambah-m-bangunan" class="btn btn-primary me-2 flex-shrink-0">
						<span class="indicator-label" data-kt-translate="btn-submit-tambah-m-bangunan">
							Simpan
						</span>
